...
### 1.1. Play the game (5 PTS)
Restart the game, and have each member in your group play for 30 rounds. Record how well each person did. (5 PTS)

### 1.2. Discuss Your Strategies (5 PTS)
Discuss with your group what strategy you might have been using. 
Did anybody find a successful strategy? 
Whose strategy was the best?
If you worked alone, reflect on and describe what strategy you were using, and how it seemed to be working.

## 2. Algorithmic Comparison

### 2.1. Algorithmic Description (30 PTS)
Try to identify three distinct algorithms you can follow to choose what move you make. 
...
Make sure to check to see that each algorithm is a clear set of rules someone else could follow.
- Algorithm 1 (10 PTS):
- Algorithm 2 (10 PTS):
- Algorithm 3 (10 PTS):
...
Reset your game. 
If working in a group, have each person in your group follow each of the algorithms for 30 moves and record how well each algorithm performs.
If working alone, you try each of your algorithms for 30 turns, and describe how well each one performed.
- Algorithm 1 (2 PTS):
- Algorithm 2 (2 PTS):
- Algorithm 3 (2 PTS):
...
The AI’s strategy and your own strategies can be thought of as a symbolic computational system as we have discussed. 
Choose the strategy that you hypothesized that most accurately predicted the AI’s behavior.
Answer the following questions about that strategy.
