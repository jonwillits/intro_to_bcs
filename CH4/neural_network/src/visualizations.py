...
def plot_dataset(training_set, test_set):
    ...
    training_y1_patch = mpatches.Patch(color=training_set_colors[1], label='Training Set: y = 1')
    training_y0_patch = mpatches.Patch(color=training_set_colors[0], label='Training Set: y = 0')
    test_y1_patch = mpatches.Patch(color=test_set_colors[1], label='Test Set: y = 1')
    test_y0_patch = mpatches.Patch(color=test_set_colors[0], label='Test Set: y = 0')
