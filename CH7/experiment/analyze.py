...
def plot_means(df, factor1, factor2, dv, figure_type="bar"):
    """
    Plots the means of a dependent variable (dv) as a function of two factors (factor1, factor2).
    ...
    factor2 (str): The second factor (used for x-axis or grouping within x-axis).
    ...
    filename = f"{factor1}_{factor2}_{dv}_{figure_type}.png"
...
def main():
    ...
    plot_means(df, "stimulus_type", "old_trial_number", "correct", "line")
