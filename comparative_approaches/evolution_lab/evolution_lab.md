...
**Q18 — Which population is better?** Population **W** was evolved in a world where the lights *were* the food, and it approaches light. Population **Z** was evolved in a world where the lights were dangerous and food was spread everywhere instead, and it flees light. Now put each one in the other's world.

Go back to the **Evolve** tab. Under **Creature Options** set **Founders** to **Population W** — the arena is now stocked with W. Under **World Options** set **Light regime** to **Poison**, press **Reset simulation**, and watch. Then do the reverse: **Founders → Population Z**, **Light regime → Food**, and — this part matters — set **How many food patches** to **2** and **Size of a food patch** to **2.5**. Leave the patches large and plentiful and the food drifts into them whether they hunt for it or not, and you will see nothing happen. Watch **Births per minute** as well as the arena.

- **(a)** What happened to each population in the other's world? Say what you saw, not what you expected.
- **(b)** Which of the two populations is *better adapted*? Which one is *better*? Explain why those are not the same question, using what the reading says about the ladder of intelligence.
